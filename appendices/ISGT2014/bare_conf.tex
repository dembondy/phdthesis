...
% have to be run twice to clear warninggood/error messages.
...
\else
  ...
  % declare the path(s) where your graphic files are
  % \graphicspath{{../eps/}}
  \graphicspath{{figures/}} % Must be EPS format!
  % and their extensions so you won't have to specify these with
  % every instance of \includegraphics
...
\title{Performance Assessment of Aggregation Control Services for Demand Response}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Daniel Esteban Morales Bondy, Giuseppe Tommaso Costanzo, Kai Heussen and Henrik W. Bindner}
\IEEEauthorblockA{Center for Electric Power and Energy, Department of Electrical Engineering\\
Technical University of Denmark\\
Email: \{bondy,guco,kh,hwbi\}@elektro.dtu.dk}}
...
\end{abstract}
\begin{IEEEkeywords}
Performance Assessment, Ancillary Services, Control Service, Demand Side Management.
\end{IEEEkeywords}
