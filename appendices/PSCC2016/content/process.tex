...
\end{equation}
The aggregator framework, simulating the considered scenario, has been implemented in \textsc{matlab} and is presented in detail in previous work\fcite{thavlov2013aggregation}.
