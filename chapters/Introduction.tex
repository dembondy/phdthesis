...
\newchapter{E}{nergy security has traditionally} been seen as a local issue. With climate change, pollution, and political instability in some of the world's energy exporters [cite], the question of energy security is seen across the layers of society, from a domestic scale to a national and cross-national scale[cite:pasqualetti].
