...
\begin{figure}[htbp!]
\centering
\includegraphics[width=0.7\textwidth]{validationMAIN2.eps}
...
\begin{figure}[htpb!]
\centering
\includegraphics[width=0.8\textwidth]{aggstatespace2.eps}
