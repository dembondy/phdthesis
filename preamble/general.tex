...
\usepackage{tabularx,booktabs,algorithmic,hyphenat,enumitem,multirow} % Used in the pscc paper
\usepackage[caption=false,font=footnotesize]{subfig}
\usepackage{amsfonts}
\usepackage[cmex10]{amsmath}
\usepackage{mathtools}
%\usepackage{epigraph}
%\renewcommand{\epigraphflush}{left}
...
\titleformat{\section}%
      ...
      {}
%\titlespacing*{\section}{0pt}{3\baselineskip plus }{1\baselineskip}
\titlespacing*{\section}{0pt}{6.5ex plus .5ex minus .2ex}{1.0ex plus .2ex minus .2ex}
\makeatother
% subsection format
